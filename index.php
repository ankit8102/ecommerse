...
<html lang="en">
    ...
    <body class="cnt-home" bgcolor="grey">
...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-3 sidebar">
				<!-- ================================== TOP NAVIGATION ================================== -->
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/photo.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/yash.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Free Refunds</h4>
						</div>
					</div>	
					<h6 class="text">1 Month Return Policy.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">No Extra shipping charges</h4>
						</div>
					</div>
					<h6 class="text">No Charges above 1000</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading blue">Big Bonanza!!</h4>
						</div>
					</div>
					<h6 class="text">FLAT 40% !!!!! </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				...
				<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary"><button class="button button5">Add to Cart</button></a></div>
				<?php } else {?>
						<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
			</div><!-- /.product -->
